...
from src.inception import ops
from src.inception import scopes
    ...
    with scopes.arg_scope([ops.conv2d, ops.fc, ops.batch_norm, ops.dropout],
      ...
      with scopes.arg_scope([ops.conv2d, ops.max_pool, ops.avg_pool],
        ...
        with tf.variable_scope('logits'):
          ...
          highfeatures = net
          # 1 x 1 x 128
          net = ops.fc(net, 128, activation=tf.nn.sigmoid, restore=restore_logits)
          # 2048
      ...
      return  net , highfeatures ,end_points
